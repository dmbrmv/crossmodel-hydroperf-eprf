...
def main(
    aoi: tuple[float, float, float, float], res_folder: str = "../data/SpatialData/SoilGrids/"
) -> None:
    """
    ...
    coverages = discover_coverages(fs, ALLOWED_PROPERTIES, ALLOWED_DEPTHS, ALLOWED_STATS, BASE)
